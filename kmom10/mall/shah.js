 ...
 */
window.Shah = (function(window, document, undefined ) {
    var Shah = {};
     ...
     * @returns string
     */
    Shah.dumpAsString = function (obj) {
        var s = '\n';
        for (var prop in obj) {
            if (obj.hasOwnProperty(prop)) {
                s += prop + ' : ' + obj[prop] + '\n';
     ...
     */
    Shah.deleteLESSFromLocalStorage = function (which) {
